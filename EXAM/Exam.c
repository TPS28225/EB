	...
	while(1){			
		if(picture_record!=OUTPUTDEVICE.picture_num){
			...
			switch(picture_record){
				case 'a':
					dispbmpex("0:/picture/exam11/picture1.bmp",0,0,0);
					break;
				case 'b':
					dispbmpex("0:/picture/exam11/picture2.bmp",0,0,0);
					break;
				case 'c':
					dispbmpex("0:/picture/exam11/picture3.bmp",0,0,0);
					break;
				case 'd':
					dispbmpex("0:/picture/exam11/picture4.bmp",0,0,0);
					break;
				case 'e':
					dispbmpex("0:/picture/exam11/picture5.bmp",0,0,0);
					break;
				case 'f':
					dispbmpex("0:/picture/exam11/picture6.bmp",0,0,0);	
					break;
				default:
					dispbmpex("0:/picture/exam11/exam11_background.bmp",0,0,0);
			}
