...
{	 
 	if(lcddev.id==0X9341||lcddev.id==0X5310||lcddev.id==0X8357)
	{		    
...
void LCD_Display_Dir(u8 dir)
{
	...
	{	  				
		...
		if(lcddev.id==0X6804||lcddev.id==0X5310||lcddev.id==0x8357)
		{ 	 
			lcddev.width=480;
			lcddev.height=320; 			
		}
